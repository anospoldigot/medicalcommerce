    ...
    <div class="bg-light">
        ...
        <div class="container py-5">
            <div class="d-none d-lg-block">
                <div class="row mb-4">
                    <div class="col-12">
                        <div class="glide banner-slider" id="xl-banner-slider">
                            <div class="glide__track" data-glide-el="track">
                                <ul class="glide__slides">
                                    @foreach ($sliders as $slider)
                                        <li class="glide__slide">
                                            <img src="{{ asset($slider->filename) }}" alt=""
                                                style="height: 100%; object-fit: cover">
                                        </li>
                                    @endforeach
                                </ul>
                        ...
                        <div class="col-2 p-1">
                            <a href="{{ route('fe.categories.products.index', $category->slug) }}">
                                <div class="rounded category-product">
                                    <img src="{{ asset('upload/images/' . $category->image) }}" alt=""
                                ...
                                <li class="glide__slide" style="height: 100%">
                                    <a href="{{ route('fe.products.show', $product->slug) }}">
                                        <div class="rounded card-product" style="height: 100%">
                                            <img src="{{ $product->assets->first()->src }}" alt=""
                                                class="card-img-top rounded">
...
@push('scripts')
    <script>
        ...
        $('#filter-btn').click(function() {
            ...
            `{{ route('fe.products.index') }}?min=${$('#min').val()}&max=${$('#max').val()}`;
        })
        ...
        const xlBanner = new Glide('#xl-banner-slider', {
            height: 300,
            autoplay: 3000,
        }).mount()
        ...
        $(document).ready(function() {
            ...
            function productTemplate(data) {
                ...
                if (data.is_discount) {
                    ...
                    priceRender +=
                        `<span class="text-primary  mb-0">${formatRupiah(data.price, 'Rp. ', ',00')}</span>`
                }
            ...
            function loadContent(page) {
                $.ajax({
                    ...
                    beforeSend: function() {
                        isLoad = true;
                        $("#content").append(
                            '<div class="loading col-12 text-center my-3">Loading...</div>');
                    },
