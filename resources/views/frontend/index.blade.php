        ...
        <div class="glide d-block d-lg-none" id="product-slider">
            <div class="glide__track" data-glide-el="track">
                ...
                <div class="glide__arrows" data-glide-el="controls">
                    <button class="glide-arrow btn-sm glide-arrow-left btn btn-outline-dark rounded-pill" data-glide-dir="<"><i class="fa-solid fa-chevron-left text-dark"></i></button>
                    <button class="glide-arrow btn-sm glide-arrow-right btn btn-outline-dark rounded-pill" data-glide-dir=">"><i class="fa-solid fa-chevron-right text-dark"></i></button>
                </div>
            </div>
        </div>
    </div>
