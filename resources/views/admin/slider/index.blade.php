...
@section('content')
<a class="btn btn-primary mb-1" href="{{ route('sliders.create') }}">
    ...
    $(document).ready(function(){
        ...
        const table =
         $('.table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route("sliders.index") }}', // memanggil route yang menampilkan data json
                columns: [
                    { 
                        data: 'id',
                        name: 'id'
            ...
            $('div.head-label').html('<h6 class="mb-0">Data Slider</h6>');
