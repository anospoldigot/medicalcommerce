...
<div class="col-12">
    ...
    <div class="breadcrumb-wrapper">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('sliders.index') }}">Slider</a>
            </li>
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('sliders.update', $sliders) }}" method="POST" id="create-slider"
                    ...
                    <div class="text-right">
                        <a href="{{ route('sliders.index') }}" class="btn btn-outline-primary"><i
