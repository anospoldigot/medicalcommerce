            ...
            <div class="card card-statistics">
                <div class="card-header">
                    ...
                    <div class="d-flex align-items-center">
                        <p class="card-text font-small-2 mr-25 mb-0">{{ date('F, Y') }}</p>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                            <div class="media">
                                ...
                                <div class="media-body my-auto">
                                    <h4 class="font-weight-bolder mb-0">{{ shortNumber($sales) }}</h4>
                        ...
                        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-xl-0">
                            <div class="media">
                                ...
                                <div class="media-body my-auto">
                                    <h4 class="font-weight-bolder mb-0">{{ shortNumber($customer) }}</h4>
                        ...
                        <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0">
                            <div class="media">
                                ...
                                <div class="media-body my-auto">
                                    <h4 class="font-weight-bolder mb-0">{{ shortNumber($product) }}</h4>
                        ...
                        <div class="col-xl-3 col-sm-6 col-12">
                            <div class="media">
                                ...
                                <div class="media-body my-auto">
                                    <h4 class="font-weight-bolder mb-0">{{ 'Rp. ' .
                                    number_format ($revenue,2,",",".")  }}</h4>
                ...
                <div class="col-lg-6 col-md-3 col-6">
                    <div class="card">
                        <div class="card-body pb-50">
                            <h6>Orders</h6>
                            <h2 class="font-weight-bolder mb-1">{{ shortNumber($total_order) }}</h2>
            ...
            <div class="card card-revenue-budget">
                <div class="row mx-0">
                    ...
                    <div class="col-md-4 col-12 budget-wrapper">
                        ...
                        <h2 class="mb-25">{{ shortNumber($revenue) }}</h2>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>Rp. {{number_format ($w->users->sum('selling_sum_amount_after_disc'),2,",",".") }}</td>
                                    {{-- <td>
                                        <div class="d-flex align-items-center">
            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        <h4 class="card-title">Target Overview</h4>
                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row border-top text-center mx-0">
                            <div class="col-6 border-right py-1">
                                <p class="card-text text-muted mb-0">Earning</p>
                                <h3 class="font-weight-bolder mb-0">{{ shortNumber($earning) }}</h3>
                            </div>
                            <div class="col-6 py-1">
                                <p class="card-text text-muted mb-0">Target</p>
                                <h3 class="font-weight-bolder mb-0">{{  shortNumber($warehouse->amount_target) }}</h3>
                            </div>
                        </div>
                    </div>
                </div>
