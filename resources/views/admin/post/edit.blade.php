                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control @error('tags') is-invalid @enderror" id="tags"
                            name="tags" placeholder="tags" value="{{ old('tags') ?? $post->tags }}">
                        @error('tags')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="form-group">
                        ...
                        <textarea id="body" name="body" autocomplete="off">{!! old('body') ?? $post->body !!}</textarea>
                        @error('body')
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div><img src="{{ $post->image_url }}" id="output" class="img-fluid" /></div>
                    @error('image')
                        <span class="text-danger mt-1">{{ $message }}</span>
                    @enderror
                </div>
