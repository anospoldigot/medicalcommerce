...
//NOT AVAILABLE in V1//NOT AVAILABLE in V1//NOT AVAILABLE in V1//NOT AVAILABLE in V1
class RequestPayloan extends Controller
{
    ...
    public function __invoke(Request $request)
    {
        ...
        if(isset($payMethod) && $payMethod == '06'){
            ...
            $nicepay->set('payValidDt', $request->input('payValidDt')); // Total gross amount
            $nicepay->set('payValidTm', $request->input('payValidTm')); // Total gross amount
